...
namespace SpotifyAdsBlocker
{
    class SpotifyPatcher
    {
        ...
        private readonly string tmpPath = Environment.GetEnvironmentVariable("TMP") + @"\SpotifyAdsBlocker\";
        ...
        public bool Patch()
        {
            Dictionary<String, String> patches = new Dictionary<string, string>
            {
                ...
                { "UPGRADE_LABEL", "'SpotifyAdsBlocker'" },
                { "UPGRADE_TOOLTIP_TEXT", "'Open SpotifyAdsBlocker Website'" },
